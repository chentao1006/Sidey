...
APP_NAME="${APP_NAME:-Sidey}"
CASK_TOKEN="${CASK_TOKEN:-sidey}"
BUNDLE_ID="${BUNDLE_ID:-com.ct106.sidey}"
TAP_OWNER="${TAP_OWNER:-chentao1006}"
TAP_REPO="${TAP_REPO:-homebrew-tap}"
TAP_NAME="${TAP_NAME:-tap}"
SOURCE_REPO="${SOURCE_REPO:-chentao1006/sidey}"
DMG_ASSET_NAME="${DMG_ASSET_NAME:-Sidey.dmg}"
if [ -n "$BREW_BIN" ]; then
...
\`\`\`sh
brew install --cask ${TAP_OWNER}/${TAP_NAME}/quitty
\`\`\`
