...
class SyncManager: ObservableObject {
    ...
    private let keysToSync = ["usePublicService", "openAI_Provider", "openAI_APIFormat", "openAI_APIKey", "openAI_BaseURL", "openAI_Model", "alwaysOnTop", "showDockIcon", "windowOpacity", "sendBehavior", "appLanguage", "hotKeyKeyCode", "hotKeyModifiers", "menuBarIcon", "assistantWindowType"]
