...
- **自动生成助手**：AI 会根据您当前正在使用的应用，通过“严肃型”或“活泼型”两种人设及其对应风格，为您自动设计最贴切的专属 AI 助手角色（例如：为 Xcode 生成“代码审计员”，为 Pages 生成“润色专家”）。
- **公共 AI 服务**：内置公共 AI 服务，无需 API Key 即可立即开始使用。受每日总请求量限制。也支持自定义 API Key 和接口地址。
